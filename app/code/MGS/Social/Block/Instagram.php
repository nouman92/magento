...
class Instagram extends Template 
{
	...
	public function getInstagramData($access_token = NULL, $count = NULL, $width = NULL, $height = NULL) { 
	...
	public function getWidgetInstagramData($user_name = NULL, $client_id = NULL, $count = NULL, $width = NULL, $height = NULL) {
